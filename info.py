...
USERNAME = environ.get('USERNAME', "https://t.me/Eppwen") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002597848806'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/KdramaTalkies')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002325987977').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
